...
static int menu_render_and_present(void) {
    ...
    menu_fill_rect_vgradient(page, pw, ph, 0, 0, pw, title_bar_h,
                             MENU_COLOR_BORDER, menu_darken(MENU_COLOR_BORDER, 3));
    ...
    if (bar_y >= 0) {
        ...
        menu_fill_rect_vgradient(page, pw, ph, 0, bar_y, pw, MENU_SOFTBAR_H,
                                 menu_darken(MENU_COLOR_BORDER, 3), MENU_COLOR_BORDER);
